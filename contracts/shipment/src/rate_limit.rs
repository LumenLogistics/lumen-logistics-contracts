...
/// # Returns
/// * `Ok(())` if within quota
/// * `Err(LumenError::RateLimitExceeded)` if quota exceeded
///
/// # Examples
/// ```rust
...
#[allow(dead_code)]
pub fn reset_quota(env: &Env, admin: &Address, actor: &Address) -> Result<(), LumenError> {
...
/// # Returns
/// * `Ok(())` if within quota
/// * `Err(LumenError)` if quota exceeded or not authorized
#[allow(dead_code)]
