...
/// # Returns
/// * `Ok(())` if within quota
/// * `Err(OrbitHaulError::RateLimitExceeded)` if quota exceeded
///
/// # Examples
/// ```rust
...
#[allow(dead_code)]
pub fn reset_quota(env: &Env, admin: &Address, actor: &Address) -> Result<(), OrbitHaulError> {
...
/// # Returns
/// * `Ok(())` if within quota
/// * `Err(OrbitHaulError)` if quota exceeded or not authorized
#[allow(dead_code)]
